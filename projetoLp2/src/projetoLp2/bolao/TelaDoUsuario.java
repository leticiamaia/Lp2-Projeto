...
/*		Toolkit tk = Toolkit.getDefaultToolkit();  
		...
		JMenu mnInformaesPessoais = new JMenu("Usu�rio");
		...
		sobreMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				JOptionPane.showMessageDialog(null, "Program designed by:\n-Let�cia Maia \n-Lucas de Matos \n-Marcela Tejo \n-�rion Winter \nVersion: 1.0 - 2014", "Sobre n�s", 0, new ImageIcon(TelaDoUsuario.class.getResource("/projetoLp2/bolao/docs/selo-RA-200.jpg")));
			}
		});
