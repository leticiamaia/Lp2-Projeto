...
public class RankingPanel extends JPanel {
	...
	public RankingPanel() {
		...
		JLabel lblNewLabel = new JLabel("Raking");
		lblNewLabel.setFont(new Font("Calibri Light", Font.PLAIN, 43));
		lblNewLabel.setBounds(10, -44, 378, 145);
		add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon(RankingPanel.class.getResource("/projetoLp2/bolao/docs/divider.jpg")));
	...
	private void initComponents() {
        ...
        jTable1.setModel(new DefaultTableModel(
        	...
        	new String[] {
        		"Sua Posi\u00E7\u00E3o", "Seu Usu\u00E1rio", "Sua Pontua\u00E7\u00E3o"
        	}
        ) {
        	/**
			 * 
