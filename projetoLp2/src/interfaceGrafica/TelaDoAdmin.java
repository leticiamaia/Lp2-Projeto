...
public class TelaDoAdmin extends JFrame {
	...
	public TelaDoAdmin() {
		...
		JLabel lblEscolhaUmaDas = new JLabel(
		...
		JLabel lblNewLabel = new JLabel(
				"<html> Seja muito bem vindo administrador! Voc\u00EA possui um papel muito importante no funcionamento desse sistema. Voc\u00EA ser\u00E1 respons\u00E1vel por cadastrar e atualizar o resultado dos jogos. </html>");
		...
		label.setIcon(new ImageIcon(TelaDoAdmin.class
		...
		bemVindoLabel.setText("Voc\u00ea est\u00e1 logado como "
				+ MeuBolao.getUsuarioLogado().getUsername() + ".");
