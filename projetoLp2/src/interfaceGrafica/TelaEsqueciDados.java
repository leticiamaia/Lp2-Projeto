...
public class TelaEsqueciDados extends JFrame {
	...
	public TelaEsqueciDados(final TelaDeLogin telaLogin) {
		...
		final JOptionPane pane = criaOptionPanePersonalizada();
		...
		label.setIcon(new ImageIcon(TelaEsqueciDados.class
				.getResource("/projetoLp2/bolao/docs/divider.jpg")));
		label.setBounds(121, 49, 496, 9);
		contentPane.add(label);

		JLabel dory = new JLabel("");
		dory.setIcon(new ImageIcon(this.getClass().getResource(
				"/projetoLp2/bolao/docs/dory-small.png")));
		...
		JLabel informacaoEsqueciSenha = new JLabel(
				"<html>Aqui voc\u00EA pode recuperar apenas sua senha atrav\u00E9s da sua resposta \u00E0 pergunta secreta escolhida no momento do seu cadastro. Caso voc\u00EA n\u00E3o se recorde do seu usu\u00E1rio ou da sua resposta/pergunta secreta, contate um administrador.</html>");
		...
		confirma.setIcon(new ImageIcon(TelaEsqueciDados.class
		...
		confirma.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				bolao = new MeuBolao();
				try {
					if (bolao.checkUsuario(usuario, pergunta, respostaSecreta,
							eMail)) {
						...
						JLabel lbl = new JLabel(
								"Voce precisa redefinir sua senha para continuar: ");
		...
		cancela.setIcon(new ImageIcon(TelaEsqueciDados.class
	...
	private JOptionPane criaOptionPanePersonalizada() {
