...
public class AlterarInfoPanel extends JPanel {
	...
	public AlterarInfoPanel(Jogador usuario) {
		...
		botaoEditarDados.setIcon(new ImageIcon(AlterarInfoPanel.class
				.getResource("/projetoLp2/bolao/docs/register_icon.gif")));
		...
		verticalDivisorLabel.setIcon(new ImageIcon(AlterarInfoPanel.class
				.getResource("/projetoLp2/bolao/docs/verticalDivider.png")));
		...
		botaoConfirmar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				novaPergunta = (String) novaPerguntaSecretaComboBox
						.getSelectedItem();
				novaResposta = recebNovaRespostaLabel.getText();
				try {
					if (MeuBolao.alterarInfo(novoNome, novoEmail,
							recebeNovaSenhaField.getText(), novaPergunta,
							novaResposta)) {
		...
		botaoConfirmar.setIcon(new ImageIcon(AlterarInfoPanel.class
		...
		botaoCancelar.setIcon(new ImageIcon(AlterarInfoPanel.class
		...
		limparFormulario.setIcon(new ImageIcon(AlterarInfoPanel.class
				.getResource("/projetoLp2/bolao/docs/broom arrow.png")));
	...
	private void criaImagemPanel() {
		...
		imagemGanhadorLabel.setIcon(new ImageIcon(AlterarInfoPanel.class
				.getResource("/projetoLp2/bolao/docs/segura-trofeu.jpg")));
	...
	private void criaTituloDadosAtuais() {
		...
		horizontalDivisorLabel.setIcon(new ImageIcon(AlterarInfoPanel.class
	...
	private void criaTituloAlterarInfo() {
		JLabel alterarInfoLabel = new JLabel(
		...
		horizontaDivisorAlteraInfoLabel.setIcon(new ImageIcon(
				AlterarInfoPanel.class
						.getResource("/projetoLp2/bolao/docs/divider.jpg")));
		horizontaDivisorAlteraInfoLabel.setBounds(-20, 75, 658, 21);
		formularioAlteraInfoPanel.add(horizontaDivisorAlteraInfoLabel);

		JLabel instrucaoAlteraInfo = new JLabel(
				"Os campos das informações que permanecerão iguais não devem ser alterados.");
	...
	private void criaAlterarInfoLabels() {
		...
		novaPerguntaSecretaLabel.setFont(new Font("Calibri Light", Font.PLAIN,
				14));
	...
	private void ehVazio() {
		if (!novoNome.equals(""))
			nomeAtual.setText(novoNome);
		if (!novoEmail.equals(""))
			emailAtual.setText(novoEmail);
		if (!novaPergunta.equals(""))
			perguntaSecreta.setText(novaPergunta);
		if (!novaResposta.equals(""))
			respostaSecreta.setText(novaResposta);
		refresh();
	}
}
